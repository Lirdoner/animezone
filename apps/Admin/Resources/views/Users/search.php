...
<?php $view['slots']->set('_sidebar_addon', $view->render('Sidebar/users/user_search', array(
    'name' => $name,
    'email' => $email,
    'ip' => $ip,
    'location' => $location,
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-search"></i> Wynik wyszukiwania <span class="badge"><?= $total ?></span></h3>
