...
<?php $view['slots']->set('_sidebar_addon', $view->render('Sidebar/users/comment_search', array('message' => $message, 'type' => $type))) ?>
<?php $view['slots']->set('_sidebar', $view->render('Sidebar/users/layout', array('current' => 'comments'))) ?>

<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-comment"></i> Lista komentarzy <span class="badge"><?= $total ?></span></h3>
