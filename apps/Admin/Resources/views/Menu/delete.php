...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="bs-callout bs-callout-info">
            <p>Jesteś pewien że chcesz usunać link: <strong><?= $menu->getName() ?></strong>?</p>
        </div>
        <form class="form-horizontal" role="form" method="post" action="<?= $app->generateUrl('menu_delete', array('menuID' => $menu->getId())) ?>">
            <div class="text-center">
                ...
                <a href="<?= $app->generateUrl('menu_index') ?>" class="btn btn-danger"><i class="fa fa-thumbs-o-down"></i> Anuluj</a>
            </div>
        </form>
    </div>
</div>