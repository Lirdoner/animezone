...
<?php $view['slots']->set('_sidebar_addon', $view->render('Sidebar/episodes/link_search')) ?>
...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <a href="<?= $app->generateUrl('links_create') ?>" class="btn btn-xs btn-success pull-right btn-helper"><i class="fa fa-plus-square"></i>Utwórz nowy</a>
    </div>
