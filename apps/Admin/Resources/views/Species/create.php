...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form class="form-horizontal" role="form" method="post" action="<?= $app->generateUrl('species_create') ?>">
            <div class="form-group">
                <label for="name" class="col-sm-2 control-label">Nazwa</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="species[name]" id="name" placeholder="Nazwa gatunku" pattern=".{1,100}" required title="Maksimum 50 znaków.">
                </div>
            </div>
            <div class="form-group">
