...
<?php $view['slots']->set('_sidebar_addon', $view->render('Sidebar/users/session_search', array('name' => $name, 'user_ip' => $user_ip, 'user_agent' => $user_agent, 'user_role' => $user_role))) ?>
<?php $view['slots']->set('_sidebar', $view->render('Sidebar/users/layout', array('current' => 'sessions'))) ?>

<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-database"></i> Wynik wyszukiwania <span class="badge"><?= $total ?></span></h3>
        ...
        <form method="post" action="<?= $app->generateUrl('sessions_update') ?>">
            <table class="table table-bordered table-striped table-hover" style="margin-bottom: 0">
                ...
                <tr>
                    ...
                    <th class="text-center col-sm-1">Adres IP</th>
