...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><i class="glyphicon glyphicon-plus-sign"></i> Nowy news</h3>
    ...
    <div class="panel-body">
        <form class="form-horizontal" role="form" method="post" action="<?= $app->generateUrl('news_create') ?>" enctype="multipart/form-data">
            <div class="form-group">
                <label for="_name" class="col-sm-2 control-label">Tytuł</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="news[title]" id="_name" placeholder="Tytuł newsa" pattern=".{1,255}" required title="Maksymalnie 255 znaków." autocomplete="off">
                </div>
            </div>
            <div class="form-group">
                <label for="_alias" class="col-sm-2 control-label">Alias</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="news[alias]" id="_alias" pattern="[\w-]{1,255}" title="Maksimum 255 alfanumerycznych znaków." autocomplete="off" data-type="news">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="input-group group-radio" id="images-list">
                        <span class="input-group-addon" style="width: 34px">
                            <input type="radio" name="news[image]" class="radio-inline">
                        </span>
                    ...
                    <div class="input-group group-radio category-preview">
                        <span class="input-group-addon" style="width: 34px">
                            <input type="radio" name="news[image]" value="000_brak.png" class="radio-inline" checked>
                        </span>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" name="news[description]" id="_description" rows="15" required></textarea>
                </div>
            </div>
            <div class="form-group">
                <label for="date" class="col-sm-2 control-label">Data publikacji</label>
                <div class="col-sm-10">
                    <input type="date" class="form-control" name="news[date]" id="date" value="<?= date_format(date_create(), 'Y-m-d') ?>" required>
                </div>
            </div>
            <div class="form-group options">
                <div class="col-lg-2 text-right"><strong>Opcje</strong></div>
                <div class="col-sm-10">
                    <label><input type="checkbox" class="checkbox-inline" name="news[comments]" value="1" checked> Komentarze</label><br>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10 collection">
                    <?php foreach($tags as $row): ?>
                        <div class="col-sm-4"><label><input type="checkbox" required class="checkbox-inline" name="tags[]" value="<?= $row['id'] ?>"> <?= $row['name'] ?></label></div>
                    <?php endforeach ?>
                </div>
            </div>
            <div class="form-group">
