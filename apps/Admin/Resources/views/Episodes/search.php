...
<?php $view['slots']->set('_sidebar_addon', $view->render('Sidebar/episodes/episode_search', array('name' => $name, 'title' => $title, 'number' => $number, 'filler' => $filler, 'enabled' => $enabled))) ?>
                        ...
                        <td class="text-center" style="padding: 8px 0 0 0">
                            <div class="btn-group btn-group-xs">
                                ...
                                <ul class="dropdown-menu text-left" role="menu">
                                    <li><a href="<?= $app->basePath('/odcinki-online/'.$row['alias'].'/'.$row['number']) ?>"><i class="fa fa-external-link"></i> Link publiczny</a></li>
