...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="bs-callout bs-callout-info">
            <p>Jesteś pewien że chcesz usunać link: <strong><?= $submitted->getTitle() ?></strong> ?</p>
        </div>
        <form class="form-horizontal" role="form" method="post" action="<?= $app->generateUrl('submitted_delete', array('episodeID' => $submitted->getId())) ?>">
            <div class="text-center">
                <input type="hidden" name="id" value="<?= $submitted->getId() ?>">
                <button type="submit" class="btn btn-success"><i class="fa fa-thumbs-o-up"></i> Usuń</button>
                <a href="<?= $app->generateUrl('submitted_index') ?>" class="btn btn-danger"><i class="fa fa-thumbs-o-down"></i> Anuluj</a>
            </div>
        </form>
    </div>
</div>