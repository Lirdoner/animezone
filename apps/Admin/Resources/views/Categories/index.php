...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><i class="glyphicon glyphicon-film"></i> Lista kategorii <span class="badge"><?= $total ?></span></h3>
        <a href="<?= $app->generateUrl('categories_create') ?>" class="btn btn-xs btn-success pull-right btn-helper"><i class="fa fa-plus-square"></i>Utwórz nową</a>
    </div>
                        ...
                        <td class="text-center" style="padding: 8px 0 0 0">
                            <div class="btn-group btn-group-xs">
                                ...
                                <ul class="dropdown-menu text-left" role="menu">
                                    <li><a href="<?= $app->basePath('/odcinki-online/'.$row['alias']) ?>" target="_blank"><i class="fa fa-external-link"></i> Link publiczny</a></li>
