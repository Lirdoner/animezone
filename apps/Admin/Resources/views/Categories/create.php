...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><i class="glyphicon glyphicon-plus-sign"></i> Nowa kategoria</h3>
    ...
    <div class="panel-body">
        <form class="form-horizontal" role="form" method="post" action="<?= $app->generateUrl('categories_create') ?>" enctype="multipart/form-data">
            <div class="form-group">
                <label for="_name" class="col-sm-2 control-label">Nazwa</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="category[name]" id="_name" placeholder="Tytuł anime" pattern=".{1,100}" required title="Maksimum 100 znaków." autocomplete="off">
                </div>
            </div>
            <div class="form-group">
                <label for="_alternate" class="col-sm-2 control-label">Alternatywny</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="category[alternate]" id="_alternate" placeholder="Alternatywny tytuł anime" pattern=".{1,100}" title="Maksimum 100 znaków." autocomplete="off">
                </div>
            </div>
            <div class="form-group">
                <label for="_alias" class="col-sm-2 control-label">Alias</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="category[alias]" id="_alias" pattern="[\w-]{1,100}" title="Maksimum 100 alfanumerycznych znaków." autocomplete="off" data-type="categories">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="input-group group-radio" id="images-list">
                        <span class="input-group-addon" style="width: 34px">
                            <input type="radio" name="category[image]" class="radio-inline">
                        </span>
                        <span class="input-group-btn" style="width: 105px;height: 34px">
                            <input type="text" class="form-control" data-autosize-input>
                        </span>
                    ...
                    <div class="input-group group-radio category-preview">
                        <span class="input-group-addon" style="width: 34px">
                            <input type="radio" name="category[image]" value="000_brak.png" class="radio-inline" checked>
                        </span>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" name="category[description]" id="_description" rows="9" required></textarea>
                </div>
            </div>
            <div class="form-group">
                <label for="_pegi" class="col-sm-2 control-label">Wiek widowni</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="category[pegi]" id="_pegi" pattern=".{1,20}" title="Maksimum 20 znaków.">
                </div>
            </div>
            <div class="form-group">
                <label for="_year" class="col-sm-2 control-label">Rok produkcji</label>
                <div class="col-sm-10">
                    <input type="number" class="form-control" name="category[year]" id="_year" pattern="\d{4}" required>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10 collection">
                    <?php foreach($types as $row): ?>
                        <div class="col-sm-4"><label><input type="checkbox" required class="checkbox-inline" name="types[<?= $row['id'] ?>]" value="<?= $row['name'] ?>"> <?= $row['name'] ?></label></div>
                    <?php endforeach ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10 collection">
                    <?php foreach($species as $row): ?>
                        <div class="col-sm-4"><label><input type="checkbox" required class="checkbox-inline" name="species[<?= $row['id'] ?>]" value="<?= $row['name'] ?>"> <?= $row['name'] ?></label></div>
                    <?php endforeach ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10 collection">
                    <?php foreach($topics as $row): ?>
                        <div class="col-sm-4"><label><input type="checkbox" required class="checkbox-inline" name="topics[<?= $row['id'] ?>]" value="<?= $row['name'] ?>"> <?= $row['name'] ?></label></div>
                    <?php endforeach ?>
                </div>
            </div>
            <div class="form-group">
