...
<?php $view['slots']->set('_title', 'Aktywacja konta - '.$app->getConfig()->anime->get('title')) ?>
<?php $view['slots']->set('_sidebar', $view->render('Sidebar/faq', array('sidebar' => $sidebar))) ?>

<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><i class="glyphicon glyphicon-user"></i> Aktywacja konta</h3>
    </div>
    <div class="panel-body">
        ...
        <?php else: ?>
            <div class="bs-callout bs-callout-info">
                <p>Jeżeli nie otrzymałeś e-maila aktywacyjnego, lub usunąłeś go omyłkowo, możesz w poniższym formularzu wysłać ponownie e-mail aktywacyjny.</p>
            </div>
        <?php endif ?>
        <form class="form-horizontal" role="form" method="post" action="<?= $app->generateUrl('user_register_resend') ?>">
